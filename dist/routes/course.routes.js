...
router.post("/course", multer_1.default("image").single("image"), validateData_1.default(course_joi_1.courseAndSectionJoi), course_controllers_1.saveCourse);
router.get("/course", course_controllers_1.getCourses);
router.get("/course/:id", course_controllers_1.getCourse);
router.put("/course/:id", multer_1.default("image").single("image"), validateData_1.default(course_joi_1.courseAndSectionJoi), course_controllers_1.updateCourse);
